          ...
          children: [
              ...
              child: Row(
                children: [
                  FilterChipButton(
                    ...
                    onTap: () => ref.read(exploreFilterProvider.notifier).state = filter.copyWith(type: 'all'),
                  ),
                  const SizedBox(width: 8),
                  FilterChipButton(
                    label: 'Public',
                    isSelected: filter.type == 'public',
                    onTap: () => ref.read(exploreFilterProvider.notifier).state = filter.copyWith(type: 'public'),
                  ),
                  const SizedBox(width: 8),
                  FilterChipButton(
                    label: 'Private',
                    isSelected: filter.type == 'private',
                    onTap: () => ref.read(exploreFilterProvider.notifier).state = filter.copyWith(type: 'private'),
                  ),
                  ...
                  FilterChipButton(
                    label: '🏆 By Ranking',
                    isSelected: filter.sortBy == 'ranking',
                    onTap: () => ref.read(exploreFilterProvider.notifier).state = filter.copyWith(sortBy: 'ranking'),
                  ),
                  const SizedBox(width: 8),
                  FilterChipButton(
                    label: 'A-Z',
                    isSelected: filter.sortBy == 'name',
                    onTap: () => ref.read(exploreFilterProvider.notifier).state = filter.copyWith(sortBy: 'name'),
                  ),
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: uniState.when(
                ...
                success: (list) => Text(
                  '${list.length} universities found',
